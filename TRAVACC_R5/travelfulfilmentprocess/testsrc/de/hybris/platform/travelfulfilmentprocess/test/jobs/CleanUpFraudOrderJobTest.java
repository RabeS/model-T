 ...
 */
package de.hybris.platform.travelfulfilmentprocess.test.jobs;
...
import de.hybris.platform.travelfulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
/**
 * The type Clean up fraud order job test.
 */
@IntegrationTest
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = TravelfulfilmentprocessConstants.ORDER_PROCESS_NAME;
