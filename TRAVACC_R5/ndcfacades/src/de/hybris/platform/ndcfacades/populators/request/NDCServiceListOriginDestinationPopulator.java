...
/**
 * NDC OriginDestination populator for {@link ServiceListRQ}
 */
public class NDCServiceListOriginDestinationPopulator extends NDCAbstractOffersOriginDestinationPopulator implements Populator<ServiceListRQ, OfferRequestData>
{

	@Override
	public void populate(final ServiceListRQ source, final OfferRequestData target) throws ConversionException
	{
