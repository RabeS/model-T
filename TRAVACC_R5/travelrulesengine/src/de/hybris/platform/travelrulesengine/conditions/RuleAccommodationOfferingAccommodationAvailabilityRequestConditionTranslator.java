...
/**
 * The type Rule accommodation offering accommodation availability request condition translator.
 */
public class RuleAccommodationOfferingAccommodationAvailabilityRequestConditionTranslator
		extends AbstractAccommodationOfferingConditionTranslator
{
	@Override
			...
			final RuleConditionDefinitionData ruleConditionDefinitionData)
	{
		...
		final RuleIrGroupCondition irAccommodationOfferingCondition = (RuleIrGroupCondition) super
				.translate(context, condition, accommodationAvailabilityRequestRAOVariable);

		irAccommodationOfferingCondition.getChildren().add(irRoomStayRAOCondition);
