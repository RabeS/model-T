...
public class AccommodationFinderComponentController extends AbstractFinderComponentController
{
	...
	@Resource(name = "accommodationOfferingTypeFacade")
	private AccommodationOfferingTypeFacade accommodationOfferingTypeFacade;
	...
	private static final String ACCOMMODATION_PROPERTY_TYPE = "accommodationPropertyType";
	...
	protected void fillModel(final HttpServletRequest request, final Model model, final AbstractFinderComponentModel component)
	{
		...
		model.addAttribute(ACCOMMODATION_PROPERTY_TYPE, accommodationOfferingTypeFacade.getAccommodationPropertyTypes());
	}
	...
	protected String buildUrlParameters(final AccommodationFinderForm accommodationFinderForm)
	{
		...
		if (StringUtils.isNotBlank(accommodationFinderForm.getAccommodationPropertyType()))
		{
			urlParameters.append(TravelacceleratorstorefrontValidationConstants.ACCOMMODATION_PROPERTY_TYPE);
			urlParameters.append(TravelacceleratorstorefrontWebConstants.EQUALS);
			urlParameters.append(String.valueOf(accommodationFinderForm.getAccommodationPropertyType()));
			urlParameters.append(TravelacceleratorstorefrontWebConstants.AMPERSAND);
		}
