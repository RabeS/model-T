...
public class DefaultTravelCheckoutFacade extends DefaultAcceleratorCheckoutFacade
{
	...
	public boolean authorizePayment(final String securityCode)
	{
		...
		if (creditCardPaymentInfoModel != null && StringUtils.isNotBlank(creditCardPaymentInfoModel.getSubscriptionId()))
		{
			...
			if (CollectionUtils.isEmpty(transactions))
			{
				...
				final PaymentTransactionData transactionData = createDefaultPaymentTransactionData(cartModel);
	...
	protected PaymentTransactionData createDefaultPaymentTransactionData(final CartModel cartModel)
	{
		...
		transactionData.setEntryNumbers(
				cartModel.getEntries().stream().map(AbstractOrderEntryModel::getEntryNumber).collect(Collectors.toList()));
