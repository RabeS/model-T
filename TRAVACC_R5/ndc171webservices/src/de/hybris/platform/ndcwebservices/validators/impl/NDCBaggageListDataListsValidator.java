...
/**
 * The Concrete class that validates {@link DataListType} element for {@link BaggageListRQ}
 */
public class NDCBaggageListDataListsValidator implements NDCRequestValidator<BaggageListRQ>
{
	...
	{
		if (Objects.isNull(baggageListRQ.getDataLists()))
		{
			addError(errorsType,
		...
		if (Objects.isNull(baggageListRQ.getDataLists().getPassengerList()))
		{
			addError(errorsType,
