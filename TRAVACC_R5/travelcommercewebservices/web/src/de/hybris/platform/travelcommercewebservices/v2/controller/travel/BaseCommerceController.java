...
import de.hybris.platform.travelcommercewebservices.exceptions.UnsupportedDeliveryModeException;
import de.hybris.platform.travelcommercewebservices.populator.options.PaymentInfoOption;
import de.hybris.platform.travelcommercewebservices.validator.PlaceOrderCartValidator;
...
public class BaseCommerceController extends BaseController
{
	...
	protected void validateStatusesEnumValue(final String statuses)
	{
		...
		final String[] statusesStrings = statuses.split(TravelcommercewebservicesConstants.OPTIONS_SEPARATOR);
