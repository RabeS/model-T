...
public abstract class AbstractAmendOrderStrategy
{
	...
	/**
	 * Returns a list of {@link TravellerModel} based on the profile profileID that correspond to the uid. If the
	 * specified profileID does not match any {@link TravellerModel} or the {@link TravellerModel} does not
