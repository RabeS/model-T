...
/**
 * Unit Test for the implementation of {@link TravellerLevelBookingActionStrategy}.
 */
@UnitTest
@RunWith(MockitoJUnitRunner.class)
public class TravellerLevelBookingActionStrategyTest
{
	@InjectMocks
	TravellerLevelBookingActionStrategy travellerLevelBookingActionStrategy;
	...
	public void setUp() throws Exception
	{
		...
		travellerLevelBookingActionStrategy.setBookingActionTypeUrlMap(bookingActionTypeUrlMap);
		...
		travellerLevelBookingActionStrategy.setBookingActionTypeAltMessagesMap(bookingActionTypeAltMessagesMap);
	}
	...
	public void testApplyStrategy()
	{
		...
		travellerLevelBookingActionStrategy.applyStrategy(bookingActionDataList, ActionTypeOption.CHECK_IN,
				reservationData);
