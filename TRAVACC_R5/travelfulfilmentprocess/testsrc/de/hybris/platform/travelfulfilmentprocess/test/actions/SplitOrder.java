 ...
 */
package de.hybris.platform.travelfulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(TravelfulfilmentprocessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(TravelfulfilmentprocessConstants.PARENT_PROCESS);
