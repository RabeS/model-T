...
public class StockInventoryPreviewRenderer extends DefaultCustomViewRenderer
{
	...
	private Component createLayout(final WidgetInstanceManager widgetInstanceManager)
	{
		...
		{
			productLabel = createLabel(Labels.getLabel(TravelbackofficeConstants.BOOKING_CLASS_PREVIEW_LABEL) + TravelbackofficeConstants.COLON, true);
		}
		else
		{
			productLabel = createLabel(Labels.getLabel(TravelbackofficeConstants.ANCILLARY_PREVIEW_LABEL) + TravelbackofficeConstants.COLON, true);
		}
