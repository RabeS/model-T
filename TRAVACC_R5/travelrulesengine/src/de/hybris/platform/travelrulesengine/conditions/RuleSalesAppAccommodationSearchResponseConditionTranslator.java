...
/**
 * The type Rule sales app accommodation search response condition translator.
 */
public class RuleSalesAppAccommodationSearchResponseConditionTranslator extends AbstractSalesApplicationConditionTranslator
{
			...
			final RuleConditionDefinitionData ruleConditionDefinitionData)
	{
		...
		return super.translate(context, condition, ruleConditionDefinitionData, accommodationSearchResponseRAOVariable);
	}
}
