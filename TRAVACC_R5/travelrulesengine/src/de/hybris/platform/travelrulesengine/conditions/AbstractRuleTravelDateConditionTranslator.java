...
public abstract class AbstractRuleTravelDateConditionTranslator implements RuleConditionTranslator {
	...
	public RuleIrCondition translate(final RuleCompilerContext paramRuleCompilerContext,
			final RuleConditionData condition, final RuleConditionDefinitionData paramRuleConditionDefinitionData, final String contextRAOVariable)
	{
		...
		final Date date = operatorDate.getValue();
		...
		irOutboundDateReturnCondition.setValue(date);
		...
		irInboundDateReturnCondition.setValue(date);
		...
		irOutboundDateSingleCondition.setValue(date);
