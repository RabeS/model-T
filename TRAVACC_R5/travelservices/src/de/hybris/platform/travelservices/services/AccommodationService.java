...
public interface AccommodationService
{
	 ...
	 * 		the catalog version to use to get the list of AccommodationModel
	 * @return the list of Accommodations found
	 */
	List<AccommodationModel> getAccommodationForAccommodationOfferingAndCatalog(String accommodationOfferingCode,
