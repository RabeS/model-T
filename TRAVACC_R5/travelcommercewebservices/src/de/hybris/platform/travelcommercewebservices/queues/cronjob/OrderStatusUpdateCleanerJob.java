 ...
 */
package de.hybris.platform.travelcommercewebservices.queues.cronjob;

import de.hybris.platform.cronjob.enums.CronJobResult;
import de.hybris.platform.cronjob.enums.CronJobStatus;
import de.hybris.platform.servicelayer.cronjob.AbstractJobPerformable;
import de.hybris.platform.servicelayer.cronjob.PerformResult;
import de.hybris.platform.travelcommercewebservices.model.expressupdate.cron.OrderStatusUpdateCleanerCronJobModel;
import de.hybris.platform.travelcommercewebservices.queues.impl.OrderStatusUpdateQueue;

import java.util.Date;


/**
 * A Cron Job for cleaning up {@link de.hybris.platform.travelcommercewebservices.queues.impl.OrderStatusUpdateQueue}.
 */
