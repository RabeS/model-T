...
public class BudgetManagementPageController extends MyCompanyPageController
{
			...
			throws CMSItemNotFoundException
	{
		...
		final SearchPageData<B2BBudgetData> searchPageData = travelB2BBudgetFacade.search(null, pageableData);
		...
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageBudgetsPage;
	}
	...
	public String viewBudgetsDetails(@RequestParam("budgetCode") final String budgetCode, final Model model)
			throws CMSItemNotFoundException
	{
		final B2BBudgetData budgetData = travelB2BBudgetFacade.getBudgetDataForCode(budgetCode);
		if (budgetData == null)
		{
		...
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageBudgetsViewPage;
	}
			...
			throws CMSItemNotFoundException
	{
		...
		{
			final B2BBudgetData b2BBudgetData = travelB2BBudgetFacade.getBudgetDataForCode(budgetCode);
			...
			b2BBudgetform.setStartDate(travelB2BBudgetFacade.getStringDateFromDate(b2BBudgetData.getStartDate()));
			b2BBudgetform.setEndDate(travelB2BBudgetFacade.getStringDateFromDate(b2BBudgetData.getEndDate()));
		...
		model.addAttribute("breadcrumbs", breadcrumbs);
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageBudgetsEditPage;
	}
			...
			final RedirectAttributes redirectModel) throws CMSItemNotFoundException, ParseException
	{
		...
		try
		{
			travelB2BBudgetFacade.updateBudget(b2BBudgetData);
		}
	...
	public String getAddBudgetPage(final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute("breadcrumbs", breadcrumbs);
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageBudgetsAddPage;
	}
			...
			final RedirectAttributes redirectModel) throws CMSItemNotFoundException, ParseException
	{
		...
		try
		{
			travelB2BBudgetFacade.addBudget(b2BBudgetData);
		}
		catch (final Exception e)
		{
			LOG.warn("Exception while saving the budget details " + e);
			...
			throws CMSItemNotFoundException
	{
		...
		else
		{
			try
			{
				travelB2BBudgetFacade.enableDisableBudget(budgetCode, true);
			}
			catch (final Exception e)
			{
			...
			throws CMSItemNotFoundException
	{
		...
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyBudgetDisableConfirm;
	}
			...
			throws CMSItemNotFoundException
	{
		try
		{
			travelB2BBudgetFacade.enableDisableBudget(budgetCode, false);
		}
		catch (final Exception e)
		{
