...
public class SopPaymentResponseController extends PaymentMethodCheckoutStepController
{
	...
	private static final Logger LOG = Logger.getLogger(SopPaymentResponseController.class);
	...
	public String getCountryAddressForm(@RequestParam("countryIsoCode") final String countryIsoCode, final Model model)
	{
		...
		return TravelcheckoutControllerConstants.Views.Fragments.Checkout.BillingAddressForm;
	}
