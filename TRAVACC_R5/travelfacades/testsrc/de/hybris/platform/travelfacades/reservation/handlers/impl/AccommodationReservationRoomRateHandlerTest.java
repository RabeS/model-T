...
/**
 * unit test for Accommodation reservation room rate handler.
 */
@UnitTest
...
public class AccommodationReservationRoomRateHandlerTest
{
	...
	public void setUp()
	{
		...
		given(orderEntry.getOrder()).willReturn(abstractOrderModel);
		given(abstractOrderModel.getNet()).willReturn(true);
