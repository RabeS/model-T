...
import de.hybris.platform.travelfulfilmentprocess.test.events.TestEventListenerCountingEvents;
...
public class FraudCheckIntegrationTest extends ServicelayerTest
{
	...
	/**
	 * Load bean definition from travelfulfilmentprocess-spring-test-fraudcheck.xml
	 */
	@BeforeClass
	public static void beforeClass()
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/travelfulfilmentprocess/test/travelfulfilmentprocess-spring-test-fraudcheck.xml"));
	...
	protected static final String PARAM_NAME_MIN_PERIOD_WAITING_FOR_CLEANUP_IN_SECONDS = "travelfulfilmentprocess.fraud.minPeriodWaitingForCleanUpInSeconds";
	protected static final String PARAM_NAME_FRAUD_SCORE_LIMIT = "travelfulfilmentprocess.fraud.scoreLimit";
	protected static final String PARAM_NAME_FRAUD_SCORE_TOLERANCE = "travelfulfilmentprocess.fraud.scoreTolerance";
	...
	public void before() throws Exception
	{
		...
		{
			importCsv("/travelfulfilmentprocess/test/testTicketEssentialData.csv", "utf-8");
		}
		importCsv("/travelfulfilmentprocess/test/testWarehouses.csv", "utf-8");
	...
	{
		final String processDefinitionName = TravelfulfilmentprocessConstants.ORDER_PROCESS_NAME;
	...
	protected String submitOrderMock(final OrderModel order)
	{
		final OrderProcessModel businessProcessModel = (OrderProcessModel) businessProcessService.createProcess(
				TravelfulfilmentprocessConstants.ORDER_PROCESS_NAME + order.getCode() + +System.currentTimeMillis(),
				TravelfulfilmentprocessConstants.ORDER_PROCESS_NAME);
	...
	/**
	 * Test scenario: Order is evaluated as potential fraud and CS Agent decides that order is fraudulent
	 *
	 * @throws CalculationException
	 * @throws InvalidCartException
	 **/
