 ...
 */
package de.hybris.platform.travelcommercewebservices.v2.helper;
...
public class OrdersHelper extends AbstractHelper
{
	...
	@Cacheable(value = "orderCache", key = "T(de.hybris.platform.commercewebservicescommons.cache.CommerceCacheKeyGenerator)"
			+ ".generateKey(true,true,'DTO',#statuses,#currentPage,#pageSize,#sort,#fields)")
	...
	@Cacheable(value = "orderCache", key = "T(de.hybris.platform.commercewebservicescommons.cache.CommerceCacheKeyGenerator)"
			+ ".generateKey(true,true,'Data',#statuses,#currentPage,#pageSize,#sort)")
