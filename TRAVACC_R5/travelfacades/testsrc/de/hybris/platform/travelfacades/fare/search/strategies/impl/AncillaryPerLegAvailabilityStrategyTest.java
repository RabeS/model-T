...
public class AncillaryPerLegAvailabilityStrategyTest
{
	...
	public void setUp()
	{
		...
		when(commerceStockService.getStockLevelQuantity(pdmA, Collections.emptyList())).thenReturn(null);
		when(commerceStockService.getStockLevelQuantity(pdmB, Collections.emptyList())).thenReturn(new Long(2));
		when(commerceStockService.getStockLevelQuantity(pdmC, Collections.emptyList())).thenReturn(new Long(0));
		when(commerceStockService.getStockLevelQuantity(pdmD, Collections.emptyList()))
