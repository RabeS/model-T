...
/**
 * Unit Test for the implementation of {@link PastLegsRestrictionStrategy}.
 */
@UnitTest
@RunWith(MockitoJUnitRunner.class)
public class PastLegsRestrictionStrategyTest
{
	private static final String ALTERNATIVE_MESSAGE = "booking.action.past.legs.alternative.message";

	@InjectMocks
	PastLegsRestrictionStrategy pastLegsRestrictionStrategy;
	@Mock
	private TimeService timeService;

	@Test
	public void testPastDepartureTimeForAllLegs()
	{
		...
		pastLegsRestrictionStrategy.applyStrategy(bookingActionDataList, reservationData);
