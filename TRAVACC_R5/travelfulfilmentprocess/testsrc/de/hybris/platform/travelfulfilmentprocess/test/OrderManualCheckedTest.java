...
import de.hybris.platform.travelfulfilmentprocess.actions.order.OrderManualCheckedAction;
import de.hybris.platform.travelfulfilmentprocess.actions.order.OrderManualCheckedAction.Transition;
...
/**
 * The type Order manual checked test.
 */
@UnitTest
public class OrderManualCheckedTest {
	...
	public void testTransitions()
	{
		...
		res.add("NOK");
		res.add("UNDEFINED");
		Assert.assertEquals(res.size(), Transition.getStringValues().size());
	}
	...
	public void testGetTransitions()
	{
		...
		res.add("NOK");
		res.add("UNDEFINED");
		Assert.assertEquals(res.containsAll(action.getTransitions()), true);
	}
}
