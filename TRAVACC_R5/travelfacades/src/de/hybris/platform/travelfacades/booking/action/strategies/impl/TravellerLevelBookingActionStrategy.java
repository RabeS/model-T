 ...
 */
public class TravellerLevelBookingActionStrategy extends AbstractBookingActionStrategy
{
			...
			final ReservationData reservationData)
	{
		...
		{
			final List<TravellerData> travellers = reservationItemData.getReservationItinerary().getTravellers();
			for (final TravellerData travellerData : travellers)
			{
