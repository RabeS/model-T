 ...
 */
public class DefaultGlobalDiscountCalculationStrategy  extends AbstractGlobalDiscountCalculationStrategy
		implements GlobalDiscountByEntryTypeCalculationStrategy
{
	...
	{
		return getGlobalDiscountForPromotionType(abstractOrder, PromotionSourceRuleModel.class);
	}
}
