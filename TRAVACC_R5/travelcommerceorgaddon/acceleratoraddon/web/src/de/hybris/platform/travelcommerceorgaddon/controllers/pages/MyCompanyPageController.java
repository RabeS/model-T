...
import de.hybris.platform.travelcommerceorgaddon.breadcrumb.impl.MyCompanyBreadcrumbBuilder;
...
import de.hybris.platform.travelcommerceorgaddon.forms.B2BCostCenterForm;
import de.hybris.platform.travelcommerceorgaddon.forms.B2BCustomerForm;
import de.hybris.platform.travelcommerceorgaddon.forms.B2BPermissionForm;
import de.hybris.platform.travelcommerceorgaddon.forms.validation.B2BBudgetFormValidator;
import de.hybris.platform.travelcommerceorgaddon.forms.validation.B2BPermissionFormValidator;
...
public class MyCompanyPageController extends AbstractSearchPageController
{
	...
	@Resource(name = "travelB2BBudgetFacade")
	...
	protected String unitDetails(final String unit, final Model model) throws CMSItemNotFoundException
	{
		...
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUnitDetailsPage;
	}
	...
	protected String addCostCenter(final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute("breadcrumbs", breadcrumbs);
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyCostCenterAddPage;
	}
	...
	protected String viewCostCenterDetails(final String costCenterCode, final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute("breadcrumbs", breadcrumbs);
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyCostCenterViewPage;
	}
	...
	protected String createUser(final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute("breadcrumbs", breadcrumbs);
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUserAddEditFormPage;
	}
	...
	protected String manageUserDetail(final String user, final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUserDetailPage;
	}
	...
	protected B2BBudgetData populateB2BBudgetDataFromForm(final B2BBudgetForm b2BBudgetForm) throws ParseException
	{
		...
		b2BBudgetData.setStartDate(travelB2BBudgetFacade.getDateFromStringDate(b2BBudgetForm.getStartDate()));
		b2BBudgetData.setEndDate(travelB2BBudgetFacade.getDateFromStringDate(b2BBudgetForm.getEndDate()));
		b2BBudgetData
	...
	public String editPermission(final String permissionCode, final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute("breadcrumbs", breadcrumbs);
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManagePermissionsEditPage;
	}
	...
	{
		final Date startDate = travelB2BBudgetFacade.getDateFromStringDate(b2BBudgetForm.getStartDate());
		final Date endDate = travelB2BBudgetFacade.getDateFromStringDate(b2BBudgetForm.getEndDate());
