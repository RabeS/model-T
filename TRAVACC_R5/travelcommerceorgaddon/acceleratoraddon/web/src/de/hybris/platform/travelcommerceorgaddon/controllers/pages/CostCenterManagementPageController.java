...
public class CostCenterManagementPageController extends MyCompanyPageController
{
			...
			throws CMSItemNotFoundException
	{
		...
		model.addAttribute("breadcrumbs", breadcrumbs);
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageCostCentersPage;
	}
			...
			throws CMSItemNotFoundException
	{
		...
		final SearchPageData<B2BBudgetData> searchPageData = travelB2BBudgetFacade.search(searchState, pageableData);
		...
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanySelectBudgetPage;
	}
			...
			@RequestParam("budgetCode") final String budgetCode) throws CMSItemNotFoundException
	{
		...
		final B2BBudgetData b2BudgetData = travelB2BBudgetFacade.getBudgetDataForCode(budgetCode);
			...
			throws CMSItemNotFoundException
	{
		...
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyCostCenterDisableConfirm;
	}
