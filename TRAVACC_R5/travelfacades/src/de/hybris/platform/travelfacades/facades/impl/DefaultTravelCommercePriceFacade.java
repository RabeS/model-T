...
public class DefaultTravelCommercePriceFacade implements TravelCommercePriceFacade
{
	...
	/**
	 * This method returns an array of the attributes used for the pricing lookup. The array of the attributes used is taken from
	 * the property pricing.lookup.attributes
	 *
	...
	@Override
	public Boolean isNetPriceProduct(final ProductModel product)
	{
		return getTravelCommercePriceService().isNetPricedProduct(product);
	}
