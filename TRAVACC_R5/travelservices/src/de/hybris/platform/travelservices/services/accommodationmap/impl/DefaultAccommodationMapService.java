...
public class DefaultAccommodationMapService implements AccommodationMapService
{
	...
	final ConfiguredAccommodationModel configuredAccommodationModel, final String transportOfferingCode)
	{
		...
		return abstractOrder.getSelectedAccommodations().stream().anyMatch(selectedAccommodation ->
				Objects.equals(selectedAccommodation.getConfiguredAccommodation(), configuredAccommodationModel) && StringUtils
						.equalsIgnoreCase(selectedAccommodation.getTransportOffering().getCode(), transportOfferingCode));
	}
