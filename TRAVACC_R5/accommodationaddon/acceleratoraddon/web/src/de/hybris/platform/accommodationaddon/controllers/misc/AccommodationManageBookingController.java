...
public class AccommodationManageBookingController extends AbstractAccommodationPageController
{
	...
	private static final String ACCOMMODATION_EXTRAS_PATH = "/manage-booking/extras";
			...
			final RedirectAttributes redirectModel)
	{
		...
		return Objects.nonNull(roomStayRefNumberToUpdate)
				? REDIRECT_PREFIX + ACCOMMODATION_EXTRAS_PATH + ROOM_STAY_REQ_PARAM + roomStayRefNumberToUpdate
				: REDIRECT_PREFIX + ACCOMMODATION_EXTRAS_PATH;
