...
import de.hybris.platform.travelfulfilmentprocess.actions.order.SendFraudErrorNotificationAction;
...
/**
 * The type Send fraud error notification test.
 */
public class SendFraudErrorNotificationTest
{
	...
	/**
	 * Test method for
	 * {@link de.hybris.platform.travelfulfilmentprocess.actions.order.SendFraudErrorNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
