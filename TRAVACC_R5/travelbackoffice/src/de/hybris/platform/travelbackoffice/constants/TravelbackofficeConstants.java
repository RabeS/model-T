...
public final class TravelbackofficeConstants extends GeneratedTravelbackofficeConstants
{
	...
	public static final String CREATE_BUNDLE_TEMPLATE_CONFIRMATION_POPUP = "com.hybris.cockpitng.widgets.configurableflow.create.bundletemplate.confirmationpopup.text";
	public static final String CREATE_BUNDLE_PREVIEW_CONFIRMATION_POPUP_TITLE = "com.hybris.cockpitng.widgets.configurableflow.create.bundletemplate.preview.confirmation.title";
	...
	public static final String BOOKING_CLASS_LABEL = "modify.inventory.bookingclass.assigninventory.wizard.bookingclass";
	public static final String BOOKING_CLASS_PREVIEW_LABEL = "create.inventory.bookingclass.preview.wizard.bookingclass";
	public static final String ANCILLARY_PREVIEW_LABEL = "create.inventory.ancillary.assigninventory.wizard.ancillary";
	...
	public static final String INVALID_PRODUCT_CODE_FOR_BOOKING_CLASS = "invalid.product.code.for.booking.class";
	public static final String NEGATIVE_VALUE_NOT_ALLOWED = "negative.value.not.allowed";
	public static final String AVAILABLE_QUANTITY_VALIDATION="available.quantity.should.be.greater.than.zero";
	public static final String MODIFY_SCHEDULE_CONFIRMATION_MESSAGE = "de.hybris.platform.travelbackoffice.widget.modifywizard.modifyscheduleconfiguration.notification.success.message";
	public static final String CREATE_BUNDLE_TEMPLATE_CONFIRMATION_MESSAGE="create.bundle.wizard.confirm.new.bundle.template.message";
