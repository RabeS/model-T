...
/**
 * Global class for all Travelacceleratorstorefront web constants. You can add global constants for your extension into
 * this class.
 */
public final class TravelacceleratorstorefrontWebConstants
{
	...
	public static final String PAYMENT_FLOW = "sop";
	public static final String GUEST_DETAILS_PATH = "/checkout/guest-details";
	public static final String ACCOMMODATION_EXTRAS_PATH = "/extras";
	...
	public static final String ACCOMMODATION_SEARCH_PATH = "/accommodation-search";
	...
	public static final String SESSION_ACCOMMODATION_FINDER_FORM = "accommodationFinderForm";
	...
	public static final String SESSION_SALES_APPLICATION = "salesApplication";

	public static final String IS_AMENDED_CART = "isAmendedCart";
	public static final String IS_B2B_CUSTOMER = "isB2BCustomer";

	private TravelacceleratorstorefrontWebConstants()
	{
