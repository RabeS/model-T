							...
							<li class="col-xs-12 ${!roomStay.nonModifiable?'y_selectedRoomStayContainer':''}">
								...
								<div class="accommodation-details col-xs-offset-5 col-xs-7 col-sm-offset-4 col-sm-8">
									<div class="row">
										...
										<div class="col-xs-12 col-sm-6 col-md-3 accommodation-number-people">
											<dl>
												<dt>
										...
										<c:if test="${not empty roomType.roomView}">
                                            <div class="col-xs-12 col-sm-6 col-md-3">
                                                <p>
                                                    <small><spring:theme code="text.accommodation.details.accommodation.viewtype" text="View" /><br />${fn:escapeXml(roomType.roomView)}</small>
                                                </p>
                                            </div>
										</c:if>
										<div class="extra-room-details col-xs-12 col-sm-6 col-md-3">
