...
/**
 * The type Rule stay dates accommodation availability request condition translator.
 */
public class RuleStayDatesAccommodationAvailabilityRequestConditionTranslator extends AbstractStayDatesConditionTranslator
{
	@Override
			...
			final RuleConditionDefinitionData ruleConditionDefinitionData)
	{
		...
		return super.translate(condition, accommodationAvailabilityRequestRAOVariable);
	}
}
