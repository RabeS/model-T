...
/**
 * The type Summary checkout step controller.
 */
@Controller
...
public class SummaryCheckoutStepController extends AbstractCheckoutStepController
{
			...
			throws CMSItemNotFoundException, CommerceCartModificationException
	{
		...
		model.addAttribute(TravelacceleratorstorefrontWebConstants.CART_TOTAL,
				travelCartFacade.getTotalsForReservation(travelCartFacade.getOriginalOrderCode()));
			...
			throws CMSItemNotFoundException, InvalidCartException, CommerceCartModificationException
	{
		...
		//Validate the cart
		if (!validateSeatSelection() || validateCart(redirectModel))
		{
	...
	protected boolean validateSeatSelection()
	{
		return travelCartFacade.validateSeatSelection();
	}
