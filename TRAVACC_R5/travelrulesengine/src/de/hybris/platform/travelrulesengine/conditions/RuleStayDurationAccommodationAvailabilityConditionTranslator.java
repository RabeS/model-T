...
/**
 * This is a condition translator to translate stay duration condition for accommodationAvailabilityRequestRAOVariable and
 * roomStayRAOVariable
 */
public class RuleStayDurationAccommodationAvailabilityConditionTranslator extends AbstractStayDurationConditionTranslator
{
	@Override
			...
			final RuleConditionDefinitionData ruleConditionDefinitionData)
	{
		...
		final RuleIrGroupCondition irStayDurationGroupCondition = super
		...
		irStayDurationGroupCondition.getChildren().add(irRoomStayRAOCondition);
