...
/**
 * unit test for {@link PerLegPerPaxPopulatePropertyMapStrategy}
 */
@UnitTest
@RunWith(MockitoJUnitRunner.class)
public class PerLegPerPaxPopulatePropertyMapStrategyTest
{
	@Mock
	...
	{
		final Map<String, Object> results = perLegPerPaxPopulatePropertyMapStrategy.populatePropertiesMap(null, 0, null, null,
	...
	{
		final Map<String, Object> results = perLegPerPaxPopulatePropertyMapStrategy.populatePropertiesMap(TEST_TRAVEL_ROUTE_CODE, 0,
