...
import de.hybris.platform.ndcwebservices.constants.Ndc171webservicesConstants;
...
@Controller
@Scope("request")
@RequestMapping(value = "/v171/servicelist")
public class ServiceListController extends NDCAbstractController
{
	...
	public ServiceListRS handleRequest(@RequestBody final ServiceListRQ serviceListRQ)
	{
		...
		try
		{
			sessionService.setAttribute(Ndc171webservicesConstants.SESSION_SALES_APPLICATION, SalesApplication.NDC);
