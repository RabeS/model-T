...
public class TravelAccountPageController extends AbstractPageController
{
	...
	private static final String MY_ACCOUNT_PROFILE_URL = "/my-account/profile";
	...
	@RequestMapping(value = "/my-account/remove-account-address", method = RequestMethod.POST)
	@RequireHardLogIn
	public String removeAddress(@RequestParam(value = "addressCode") final String addressCode, final RedirectAttributes redirectAttributes)
	{
		final AddressData addressData = new AddressData();
		addressData.setId(addressCode);
		userFacade.removeAddress(addressData);

		GlobalMessages.addFlashMessage(redirectAttributes, GlobalMessages.CONF_MESSAGES_HOLDER, "account.confirmation.address.removed");
		return REDIRECT_PREFIX + MY_ACCOUNT_PROFILE_URL;
	}
