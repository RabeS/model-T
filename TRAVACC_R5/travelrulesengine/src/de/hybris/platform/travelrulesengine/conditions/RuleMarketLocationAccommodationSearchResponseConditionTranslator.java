...
public class RuleMarketLocationAccommodationSearchResponseConditionTranslator extends AbstractLocationConditionTranslator
{
			...
			final RuleConditionDefinitionData ruleConditionDefinitionData)
	{
		...
		createGroupLocationOrCondition(inclMarLocations, ACCOMMODATION_MARKET_LOCATIONS_ATTRIBUTE,
				accommodationSearchResponseRAOVariable, irLocationCondition, RuleIrAttributeOperator.CONTAINS);

		// EXCLUDED ACCOMMODATION LOCATIONS
		createGroupLocationOrCondition(exclMarLocations, ACCOMMODATION_MARKET_LOCATIONS_ATTRIBUTE,
				accommodationSearchResponseRAOVariable, irLocationCondition, RuleIrAttributeOperator.NOT_CONTAINS);

		// USER ADDRESS CONDITION
		createAddressCondition(ACCOMMODATION_MARKET_LOCATIONS_ATTRIBUTE, accommodationSearchResponseRAOVariable,
				irLocationCondition);
