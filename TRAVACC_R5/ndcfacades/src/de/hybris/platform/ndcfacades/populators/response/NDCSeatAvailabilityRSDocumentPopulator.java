...
/**
 * NDC Msg Document Type Populator for {@link SeatAvailabilityRS}
 */
public class NDCSeatAvailabilityRSDocumentPopulator extends NDCMsgDocumentTypePopulator
		implements Populator<OfferResponseData, SeatAvailabilityRS>
{
	...
	{
		seatAvailabilityRS.setDocument(getMsgDocumentType());
	}
}
