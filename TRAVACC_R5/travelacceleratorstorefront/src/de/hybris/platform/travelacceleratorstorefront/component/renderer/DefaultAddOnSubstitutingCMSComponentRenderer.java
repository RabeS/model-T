 ...
 */
package de.hybris.platform.travelacceleratorstorefront.component.renderer;
		...
		extends DefaultAddOnCMSComponentRenderer<C>
{
	...
	private static final String UI_EXPERIENCE_RESPONSIVE = "responsive";
	...
	public void renderComponent(final PageContext pageContext, final C component) throws ServletException, IOException
	{
		...
		// The only difference to the base class to ensure we can see the returned view
		final String view = getView(component);
	...
	{
		return UI_EXPERIENCE_RESPONSIVE;
	}
