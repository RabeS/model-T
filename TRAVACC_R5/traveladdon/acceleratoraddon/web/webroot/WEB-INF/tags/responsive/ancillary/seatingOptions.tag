...
<div class="panel-body">
	<div class="row">
		...
		<div class="col-xs-12 col-sm-4">
			<a id="y_selectSeat" disabled href="#y_ancillaryPanelSeatingOptions" data-toggle="modal" data-target="y_ancillaryPanelSeatingOptions" aria-expanded="false" aria-controls="y_ancillaryPanelSeatingOptions" class="btn btn-primary btn-block" data-amend="${fn:escapeXml(amend)}">
	...
	<div class="modal fade modal-extra-details seatmap-modal" id="y_seatmapModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content tab-wrapper">
				<div id="carousel-generic" class="carousel owl-carousel owl-theme y_svgdiv">
						...
						<c:forEach var="originDestinationOption" items="${itinerary.originDestinationOptions}">
							<c:if test="${originDestinationOption.active}">
								<c:forEach var="transportOffering" items="${originDestinationOption.transportOfferings}">
									<div class="y_transportOffering item" data-tabid="${transportOfferingIndex}">
														...
														<c:if test="${originDestinationOption.active}">
															...
															<div role="tabpanel" class='tab-pane fade in' id="seating-tab-${fn:escapeXml(passengerTabId)}">
																...
																<div class="seatLegend-panel hidden-xs col-sm-12">
																	<li class="legendLabels col-xs-12">
																		<div>
																			<div class="seat-icon-legend currentSelection y_cabinClassIcon"></div>
																			<label class="y_cabinClassLabel">
																				<spring:theme code="text.ancillary.seatmap.seating.legend.label.cabin.class" text="Cabin Class" />
																			</label>
																		</div>
																		<div>
																			<div class="seat-icon-legend currentSelection"></div>
																			<label>
																				<spring:theme code="text.ancillary.seatmap.seating.legend.label.current.selection" text="Current Selection" />
																			</label>
																		</div>
																		<div>
																			<div class="seat-icon-legend selected"></div>
																			<label>
																				<spring:theme code="text.ancillary.seatmap.seating.legend.label.selected" text="Selected" />
																			</label>
																		</div>
																		<div>
																			<div class="seat-icon-legend unavailable"></div>
																			<label>
																				<spring:theme code="text.ancillary.seatmap.seating.legend.label.unavailable" text="Unavailable" />
																			</label>
																		</div>
																	</li>
																</div>
