...
public class ManageTransportOfferingForScheduleConfigurationJobTest
{
	...
	public void setUp()
	{
		...
		Mockito.doNothing().when(travelBackofficeNotificationUtils).createNotificationAsWorkFlowAction(Matchers.anyObject(),
	...
	public void testPerformWhenEndDateGreaterThanStartDate() throws ParseException
	{
		...
		verify(backofficeTransportOfferingService,times(1)).createTransportOfferingForScheduleConfiguration(Matchers.any());
	}
