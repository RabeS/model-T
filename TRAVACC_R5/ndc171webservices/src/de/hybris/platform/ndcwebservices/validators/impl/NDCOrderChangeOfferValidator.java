...
public class NDCOrderChangeOfferValidator implements NDCRequestValidator<OrderChangeRQ>
{
	...
	/**
	 * Validates, depending on the actionType the required associations
	 *
	 * @param actionType
	 * 		the action type
	 * @param orderItems
	...
	/**
	 * Checks if the selected {@link OrderItem} can be applied to the referenced {@link PassengerType}
	 *
	 * @param orderItems
	 * 		the order items
	 * @param errorsType
