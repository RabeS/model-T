...
/**
 * Global class for all Ndc171facades constants. You can add global constants for your extension into this class.
 */
public final class NdcfacadesConstants extends GeneratedNdc171facadesConstants
{
	...
	public static final String MISMATCH_ORDER_USER = "ndcfacades.validation.error.mismatchofuser";
	public static final String INVALID_PASSENGER = "ndcfacades.validation.error.invalidpassenger";
	public static final String INVALID_ACTION_FOR_PASSENGER = "ndcfacades.validation.error.invalidactionforpassenger";
	...
	public static final String OFFER_ITEM_ID_PATTERN = "^([A-Z]{3})?\\|[0-1]\\|[A-Z]{3}(\\_[A-Z]{3}){1,}\\|[A-Za-z0-9\\_|\\#\\|]{0,}$";
