...
import de.hybris.platform.ndcfacades.ndc.SrvPriceResMetadataType.Other;
import de.hybris.platform.ndcfacades.ndc.SrvPriceResMetadataType.Other.OtherMetadata;
...
/**
 * NDC Metadata Populator populate currency related information for {@link ServicePriceRS}
 */
public class NDCServicePriceRSMetadataPopulator implements Populator<OfferResponseData, ServicePriceRS>
{
	...
	{
		final ServicePriceRS.Metadata metadata = new ServicePriceRS.Metadata();
		...
		servicePriceRS.setMetadata(metadata);
	}
