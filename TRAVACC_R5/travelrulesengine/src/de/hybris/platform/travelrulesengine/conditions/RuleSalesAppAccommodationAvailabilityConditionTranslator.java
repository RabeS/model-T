...
/**
 * This is a condition translator to translate sales application condition for accommodationAvailabilityRequestRAOVariable and
 * roomStayRAOVariable
 */
public class RuleSalesAppAccommodationAvailabilityConditionTranslator extends AbstractSalesApplicationConditionTranslator
{
	@Override
			...
			final RuleConditionDefinitionData ruleConditionDefinitionData)
	{
		...
		final RuleIrGroupCondition ruleIrGroupCondition = (RuleIrGroupCondition)
				super.translate(context, condition, ruleConditionDefinitionData, accommodationAvailabilityRequestRAOVariable);
