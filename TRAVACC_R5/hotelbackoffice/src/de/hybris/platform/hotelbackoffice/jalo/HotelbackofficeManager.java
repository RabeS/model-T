 ...
 */
package de.hybris.platform.hotelbackoffice.jalo;
...
import de.hybris.platform.hotelbackoffice.constants.HotelbackofficeConstants;
 ...
 */
public class HotelbackofficeManager extends GeneratedHotelbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(HotelbackofficeManager.class.getName());
	 ...
	 */
	public static HotelbackofficeManager getInstance()
	{
		return (HotelbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(HotelbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HotelbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of HotelbackofficeManager called.");
		}
	}
