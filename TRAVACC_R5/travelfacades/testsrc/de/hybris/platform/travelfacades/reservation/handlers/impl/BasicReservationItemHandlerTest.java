...
public class BasicReservationItemHandlerTest
{
	@Mock
	...
	@InjectMocks
	BasicReservationItemHandler handler;
	...
	public void testNullEmptyOrderEntries()
	{
		...
		final ReservationData reservationData = new ReservationData();
		handler.handle(testDataSetUp.createCartModel(Collections.emptyList()), reservationData);
		assertTrue(reservationData.getReservationItems().isEmpty());
	}
