...
/**
 * NDC Success Populator for {@link BaggageChargesRS}
 */
public class NDCBaggageChargesSuccessPopulator extends NDCRSSuccessPopulator
		implements Populator<OfferResponseData, BaggageChargesRS>
{
	...
	{
		baggageChargesRS.setSuccess(getNDCSuccessType());
	}
}
