...
/**
 * unit test for Add standard bundle to cart strategy.
 */
@UnitTest
...
public class AddStandardBundleToCartStrategyTest
{
	...
	public void testAddBundleToCart() throws CommerceCartModificationException
	{
		...
		given(travelBundleCommerceCartFacade.startBundle(Matchers.anyString(), Matchers.anyString(), Matchers.anyLong(),Matchers.any()))
