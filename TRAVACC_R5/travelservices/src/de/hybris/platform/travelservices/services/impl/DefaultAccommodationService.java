...
public class DefaultAccommodationService implements AccommodationService
{
	...
	@Override
	public List<AccommodationModel> getAccommodationForAccommodationOfferingAndCatalog(final String accommodationOfferingCode,
			final String catalogVersion)
	{
		return getAccommodationDao().findAccommodationForAccommodationOfferingAndCatalog(accommodationOfferingCode, catalogVersion);
	}
