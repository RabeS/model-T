...
/**
 * The type Rule stay duration accommodation reservation condition translator.
 */
public class RuleStayDurationAccommodationReservationConditionTranslator extends AbstractStayDurationConditionTranslator
{
	@Override
