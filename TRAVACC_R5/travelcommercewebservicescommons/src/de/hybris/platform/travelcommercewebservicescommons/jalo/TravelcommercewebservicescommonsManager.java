 ...
 */
package de.hybris.platform.travelcommercewebservicescommons.jalo;
...
import de.hybris.platform.travelcommercewebservicescommons.constants.TravelcommercewebservicescommonsConstants;



/**
 * This is the extension manager of the Travelcommercewebservicescommons extension.
 */
public class TravelcommercewebservicescommonsManager extends GeneratedTravelcommercewebservicescommonsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(TravelcommercewebservicescommonsManager.class);
	 ...
	 */
	public static TravelcommercewebservicescommonsManager getInstance()
	{
		return (TravelcommercewebservicescommonsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TravelcommercewebservicescommonsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TravelcommercewebservicescommonsManager() // NOPMD 
	{
		LOG.debug("constructor of TravelcommercewebservicescommonsManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of TravelcommercewebservicescommonsManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of TravelcommercewebservicescommonsManager called, current tenant: {}", getTenant().getTenantID());
	}
