...
/**
 * The type Default accommodation offering dao integration test.
 */
@IntegrationTest
public class DefaultAccommodationOfferingDaoIntegrationTest extends ServicelayerTransactionalTest
{
	@Resource
	...
	@Test
	public void testFindAccommodationOffering()
	{
		final AccommodationOfferingModel accommodationOffering = accommodationOfferingDao
				.findAccommodationOffering(code);
		Assert.assertNotNull(accommodationOffering);
		Assert.assertEquals(code, accommodationOffering.getCode());
	}

	@Test
	public void testFindAccommodationOfferings()
	{
		final List<AccommodationOfferingModel> accommodationOfferings = accommodationOfferingDao.findAccommodationOfferings();
		Assert.assertTrue(CollectionUtils.isNotEmpty(accommodationOfferings));
	}

	@Test
	public void testFindAccommodationOfferingsWithBatch()
	{
		final SearchResult<AccommodationOfferingModel> accommodationOfferings = accommodationOfferingDao
				.findAccommodationOfferings(10, 0);
