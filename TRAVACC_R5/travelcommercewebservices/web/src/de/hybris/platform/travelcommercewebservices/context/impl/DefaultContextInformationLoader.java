 ...
 */
package de.hybris.platform.travelcommercewebservices.context.impl;
...
import de.hybris.platform.travelcommercewebservices.context.ContextInformationLoader;
import de.hybris.platform.travelcommercewebservices.exceptions.InvalidResourceException;
import de.hybris.platform.travelcommercewebservices.exceptions.RecalculationException;
import de.hybris.platform.travelcommercewebservices.exceptions.UnsupportedCurrencyException;
import de.hybris.platform.travelcommercewebservices.exceptions.UnsupportedLanguageException;
...
public class DefaultContextInformationLoader implements ContextInformationLoader
{
	...
	{
		final String languageString = request.getParameter(TravelcommercewebservicesConstants.HTTP_REQUEST_PARAM_LANGUAGE);
	...
	{
		final String currencyString = request.getParameter(TravelcommercewebservicesConstants.HTTP_REQUEST_PARAM_CURRENCY);
	 ...
	 * <i>/rest/v2/mysite/cart</i>, or <br>
	 * <i>/rest/v2/mysite/customers/current</i><br>
	 ...
	 * Default and fallback value equals to <i>/rest/v2/</i><br>
	 * <p>
	...
	protected String[] getSpecialUrlCharacters()
	{
		final String configurationString = getConfigurationService().getConfiguration()
				.getString(TravelcommercewebservicesConstants.URL_SPECIAL_CHARACTERS_PROPERTY,
						TravelcommercewebservicesConstants.DEFAULT_URL_SPECIAL_CHARACTERS);
