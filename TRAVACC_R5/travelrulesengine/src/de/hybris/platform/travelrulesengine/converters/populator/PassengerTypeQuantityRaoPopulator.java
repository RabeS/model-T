...
/**
 * Populates Passenger Type Quantity attribute on FareSearchRequestRAO
 */
public class PassengerTypeQuantityRaoPopulator implements Populator<FareSearchRequestData, FareSearchRequestRAO>
{
	private Converter<PassengerTypeData, PassengerTypeRAO> passengerTypeRaoConverter;

	@Override
	public void populate(final FareSearchRequestData fareSearchRequestData, final FareSearchRequestRAO fareSearchRequestRAO)
			throws ConversionException
	{
		...
		fareSearchRequestRAO.setPassengerTypeQuantities(passengerTypeQuantities);
	}
