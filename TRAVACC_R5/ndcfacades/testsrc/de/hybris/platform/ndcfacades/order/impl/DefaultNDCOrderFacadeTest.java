...
import de.hybris.platform.ndcfacades.ndc.OrderRetrieveRQ.Query.Filters.Passengers.Name;
import de.hybris.platform.ndcfacades.ndc.OrderRetrieveRQ.Query.Filters.Passengers.Name.Surname;
...
public class DefaultNDCOrderFacadeTest
{
	...
	protected OrderChangeRQ createOrderChangeRQ() throws NDCOrderException
	{
		...
		final de.hybris.platform.ndcfacades.ndc.Passenger associationsPassenger = new de.hybris.platform.ndcfacades.ndc.Passenger();
		associationsPassenger.setProfileID(profileId);
