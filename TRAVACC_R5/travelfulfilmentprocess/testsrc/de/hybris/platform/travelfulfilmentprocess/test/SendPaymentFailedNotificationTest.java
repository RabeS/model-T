...
import de.hybris.platform.travelfulfilmentprocess.actions.order.SendPaymentFailedNotificationAction;
...
/**
 * The type Send payment failed notification test.
 */
public class SendPaymentFailedNotificationTest
{
	...
	/**
	 * Test method for
	 * {@link de.hybris.platform.travelfulfilmentprocess.actions.order.SendPaymentFailedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
