...
/**
 * unit test for {@link PriceDescendingSortStrategy}
 */
@UnitTest
@RunWith(MockitoJUnitRunner.class)
public class PriceDescendingSortStrategyTest
{
	@InjectMocks
	...
	public void testSort()
	{
		...
		priceDescendingSortStrategy.sort(accommodationSearchResponseData);
		Assert.assertEquals(BigDecimal.valueOf(400), accommodationSearchResponseData.getProperties()
				.get(0).getRateRange().getActualRate().getValue());
	...
	private List<PropertyData> createProperties()
	{
		...
		properties.add(createPropertyData(100));
