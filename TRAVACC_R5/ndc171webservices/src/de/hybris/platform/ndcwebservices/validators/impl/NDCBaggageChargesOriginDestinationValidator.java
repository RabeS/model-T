...
/**
 * The Concrete class that validates origin destination for {@link BaggageChargesRQ}
 */
public class NDCBaggageChargesOriginDestinationValidator extends NDCOriginDestinationValidator<BaggageChargesRQ>
{
	@Override
