...
<form:form commandName="manageMyBookingForm" action="${manageMyBookingUrl}" class="col-xs-12 form-background" id="y_manageBookingsForm">
	<fieldset>
		<legend class="primary-legend">
			<a class="panel-heading panel-header-link collapsable collapsed" role="button" data-toggle="collapse" data-target="#manage-booking" aria-expanded="false" aria-controls="manage-booking"><spring:theme code="manage.booking.title" text="Manage Booking" /></a>
		</legend>
...
<div class="modal fade manage-booking-modal" tabindex="-1" id="y_manageBookingModal" role="dialog" aria-labelledby="manageBookingLabel">
	<div class="modal-dialog" role="document">
		<div id="y_modalContent" class="modal-content">
		</div>
	</div>
</div>
