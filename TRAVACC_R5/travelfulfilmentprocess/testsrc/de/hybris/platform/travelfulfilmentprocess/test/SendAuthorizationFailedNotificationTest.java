...
import de.hybris.platform.travelfulfilmentprocess.actions.order.SendAuthorizationFailedNotificationAction;
...
/**
 * The type Send authorization failed notification test.
 */
public class SendAuthorizationFailedNotificationTest
{
	...
	/**
	 * Test method for
	 * {@link de.hybris.platform.travelfulfilmentprocess.actions.order.SendOrderPlacedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
