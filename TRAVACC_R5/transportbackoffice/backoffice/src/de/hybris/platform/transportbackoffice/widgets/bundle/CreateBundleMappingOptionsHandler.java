 ...
 */
public class CreateBundleMappingOptionsHandler implements FlowActionHandler
{
	protected static final String MAPPING_ATTRIBUTE_KEY = "mapping";
	protected static final String CREATE_BUNDLE_WIZARD_FIRST_STEP_ERROR_MESSAGE = "create.bundle.wizard.first.step.error.message";
	protected static final String CREATE_BUNDLE_WIZARD_FIRST_STEP_ERROR_TITLE = "create.bundle.wizard.first.step.error.title";
	...
	protected void resetReferenceSelection(final WidgetModel widgetModel, final String radioId)
	{
		...
		final BundleTemplateTransportOfferingMappingModel mapping = (BundleTemplateTransportOfferingMappingModel)
				defaultWidgetModel.get(MAPPING_ATTRIBUTE_KEY);
		if(mapping.getProperty(radioId) != null)
		{
			mapping.setProperty(radioId, null);
		}
	}
