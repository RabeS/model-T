...
public interface TravelBundleTemplateDao extends BundleTemplateDao
{
	 ...
	 */
	BundleTemplateModel findBundleTemplateByCodeAndCatalogVersion(String bundleId, CatalogVersionModel catalog) throws ModelNotFoundException,AmbiguousIdentifierException;
}
