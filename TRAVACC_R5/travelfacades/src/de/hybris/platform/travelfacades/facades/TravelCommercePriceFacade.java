...
public interface TravelCommercePriceFacade
{
	...
	/**
	 * Method to get the price information for product code, search key and search value. The prices are searched in the order of
	 * transportoffering, sector, route and default price. The first available price will be returned.
	 *
	 * @param productCode
	 * 		the product code
	...
	/**
	 * This method checks if any ChangeProductPriceBundleRule exist for the product, if found then it created PriceInformation
	 * based on the price set within the rule
	 *
	...
	/**
	 * Method to get the price level and value for product code, search key and search value. The price level is searched in the
	 * order of transportoffering, sector, route and default price. The first available price level will be returned.
	 *
	 * @param product
	 * 		the product
	 * @param transportOfferingCode
	...
	/**
	 * Method to set price and tax search criteria in session context These values will be used to retrieve prices during cart
	...
	/**
	 * Method to set price search criteria in session context These values will be used to retrieve prices during cart calculation
	...
	/**
	 * Method to set values in Session Context. These values will be used to retrieve taxes during cart calculation when the
