			...
			<div class="row">
				<div class="accommodation-name-awards col-xs-12 col-sm-8">
					<div class="clearfix">
						<div class="col-xs-12">
							<div class="row">
								<h3>
									...
									<a href="${detailsPageUrl}?${urlParameters}">${property.accommodationOfferingName}</a>
								</h3>
						...
						<div>
                            <c:if test="${not empty property.brandName}">
                                <div class="col-xs-12">
                                    <div class="row accommodation-brand">
                                        <spring:theme code="text.accommodation.listing.brand.by" text="By "/>
                                        ${fn:escapeXml(property.brandName)}
                                    </div>
                                </div>
                            </c:if>
                        </div>
				...
				<div class="col-xs-12 col-sm-6 reviews">
					...
					<c:forEach var="award" items="${property.awards}">
						<c:if test="${award.type eq 'USER_RATING'}">
							...
							<p>
								<a href="#" class="y_customerReview" data-accommodationofferingcode="${fn:escapeXml(property.accommodationOfferingCode)}">
