...
public class DefaultTravelCommerceCartServiceTest
{
	...
	public void testAddToCartNewBundle() throws CommerceCartModificationException, CalculationException
	{
		...
		final OfferGroupModel offerGroup1 = new OfferGroupModel();
		...
		final OfferGroupModel offerGroup2 = new OfferGroupModel();
	...
	public void testAddPerLegBundleProductToCart() throws CommerceBundleCartModificationException
	{
		...
		final OfferGroupModel offerGroup3 = new OfferGroupModel();
		...
		final OfferGroupModel offerGroup4 = new OfferGroupModel();
	...
	public void testGetOrderEntriesForCategory()
	{
		...
		final OfferGroupModel categoryModel = new OfferGroupModel();
	...
	public void testRemoveSelectedAccommodationFromCart()
	{
		...
		configuredAccommodationModel3.setUid("TEST_CONFIGURED_ACCOMMODATION_CODE");
	...
	private class TestSetup
	{
				...
				final List<TaxValue> taxValues)
		{
			...
			final Set<Integer> entryGroupNumbers = new HashSet<Integer>();
		...
		private EntryGroup createEntryChildGroups(final int groupNumber)
		{
