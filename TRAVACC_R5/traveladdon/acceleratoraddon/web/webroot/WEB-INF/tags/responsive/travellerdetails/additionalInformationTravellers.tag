...
<div class="modal fade y_additionalInformationModal" id="additionalInformationModal_${fn:escapeXml(idx)}" data-positionid="y_additionalInformation_${fn:escapeXml(idx)}" tabindex="-1" role="dialog" aria-labelledby="additionalInformationModalLabel_${fn:escapeXml(idx)}">
