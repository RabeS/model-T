...
<form:form id="${fn:escapeXml(formId)}" class="col-xs-12 form-background">
	...
	<fieldset>
		<legend class="primary-legend">
			<a class="panel-heading panel-header-link collapsable collapsed" role="button" data-toggle="collapse" data-target="#flight-status" aria-expanded="false" aria-controls="manage-booking"><spring:theme code="next.transport.offering.status.title" text="Next Flight Status" /></a>
		</legend>
