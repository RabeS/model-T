...
/**
 * This is a condition translator to translate search date condition for accommodationAvailabilityRequestRAOVariable and
 * roomStayRAOVariable
 */
public class RuleSearchDateAccommodationAvailabilityConditionTranslator implements RuleConditionTranslator
{
			...
			final RuleConditionDefinitionData ruleConditionDefinitionData)
	{
		...
		irDateGroupCondition.getChildren().add(irRoomStayRAOCondition);
