...
public class TaxHandler implements FareSearchHandler
{
	...
	{
		final String offerGroup = productData.getCategories().stream().findFirst().get().getCode();
		final String mapping = getOfferGroupToOriginDestinationMapping().getOrDefault(offerGroup,
