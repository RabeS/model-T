...
public interface TransportOfferingService {
     ...
     *
     * @param code the unique code for a transport offering
     ...
     *
     * @param batchSize
     *      the size of search result
     * @param offset
     *      the offset
     * @return SearchResult<TransportOfferingModel> transport offerings
     */
    SearchResult<TransportOfferingModel> getTransportOfferings(int batchSize, int offset);

    /**
     * Get a list of TransportOfferingModel by number and departureDate.
     *
     * @param number        the number of requested transport offering
     * @param departureDate the departure date of requested transport offering
     * @return List<TransportOfferingModel> transport offerings
     */
     ...
     *
     * @param transportOfferingCodes the collection of codes
     ...
     *
     * @param orderEntryList the order entry list
