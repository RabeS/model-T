...
/**
 * The type Default auto accommodation allocation strategy test.
 */
@UnitTest
public class DefaultAutoAccommodationAllocationStrategyTest
{
	private DefaultAutoAccommodationAllocationStrategy autoAccommodationAllocationStrategy;
	@Mock
	...
	public void setUp() throws Exception
	{
		...
		autoAccommodationAllocationStrategy = new DefaultAutoAccommodationAllocationStrategy();
	...
	public void testAutoAllocateSeatForOutboundLeg()
	{
		...
		when(autoAccommodationAllocationStrategy.getCommerceStockService().getStockLevelQuantity(Matchers.any(ProductModel.class),
				Matchers.anyCollectionOf(WarehouseModel.class))).thenReturn(10L);
