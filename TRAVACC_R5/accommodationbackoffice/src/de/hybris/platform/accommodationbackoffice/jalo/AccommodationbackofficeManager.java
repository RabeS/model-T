 ...
 */
package de.hybris.platform.accommodationbackoffice.jalo;
 ...
 */
public class AccommodationbackofficeManager extends GeneratedAccommodationbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AccommodationbackofficeManager.class.getName());
	 ...
	 */
	public static AccommodationbackofficeManager getInstance()
	{
		return (AccommodationbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AccommodationbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AccommodationbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AccommodationbackofficeManager called.");
		}
	}
