...
public final class TravelacceleratorstorefrontValidationConstants
{
	...
	public static final String ACCOMMODATION_PROPERTY_TYPE = "accommodationPropertyType";
	...
	public static final String REGEX_QUERY_PARAMETER = "^(:?[\\p{L}\\p{N}\\-\\+\\_\\/\\s\\p{Sc}\\|]*)*$";
	public static final String REGEX_ALPHANUMERIC = "^[a-zA-Z]+[\\d_]*$";
