...
import de.hybris.platform.travelcommerceorgaddon.forms.B2BUnitForm;
...
public class BusinessUnitManagementPageController extends MyCompanyPageController
{
	...
	public String manageUnits(final Model model) throws CMSItemNotFoundException
	{
		...
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUnitsPage;
	}
			...
			throws CMSItemNotFoundException
	{
		...
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUnitDisablePage;
	}
	...
	public String editUnit(@RequestParam("unit") final String unit, final Model model) throws CMSItemNotFoundException
	{
		...
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUnitEditPage;
	}
			...
			throws CMSItemNotFoundException
	{
		...
		breadcrumbs.add(new Breadcrumb("/my-company/organization-management/manage-units/create?unit=",
				...
				{ StringUtils.isEmpty(parentUnit) ? unit : parentUnit }, "Create Child Unit for Unit: {0}", getI18nService().getCurrentLocale()), null));
		model.addAttribute("breadcrumbs", breadcrumbs);
		...
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		model.addAttribute("businessProcesses", getBusinessProcesses());
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUnitCreatePage;
	}
	...
	public String addAddress(@RequestParam("unit") final String unit, final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUnitAddAddressPage;
	}
