...
/**
 * The type Rule accommodation provider reservation condition translator.
 */
public class RuleAccommodationProviderReservationConditionTranslator implements RuleConditionTranslator
{
			...
			final RuleConditionDefinitionData ruleConditionDefinitionData)
	{
		...
		irProviderCondition.getChildren().add(irAccommodationReservationCondition);
