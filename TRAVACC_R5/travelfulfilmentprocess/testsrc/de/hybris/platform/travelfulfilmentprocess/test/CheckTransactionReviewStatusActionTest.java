...
import de.hybris.platform.travelfulfilmentprocess.actions.order.CheckTransactionReviewStatusAction;
import de.hybris.platform.travelfulfilmentprocess.actions.order.CheckTransactionReviewStatusAction.Transition;
...
/**
 *
 * Unit test for the implementation {@link CheckTransactionReviewStatusAction}
 *
 */
@UnitTest
...
public class CheckTransactionReviewStatusActionTest
{
	...
	{
		final Set<String> transtionsSet = new HashSet<>();
		transtionsSet.add(Transition.OK.toString());
		transtionsSet.add(Transition.NOK.toString());
		transtionsSet.add(Transition.WAIT.toString());
		assertEquals(transtionsSet.size(), action.getTransitions().size());
	}
