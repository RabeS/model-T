...
import de.hybris.platform.travelcommerceorgaddon.forms.CustomerResetPasswordForm;
...
public class UserManagementPageController extends MyCompanyPageController
{
			...
			throws CMSItemNotFoundException
	{
		...
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUsersPage;
	}
			...
			throws CMSItemNotFoundException
	{
		...
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUserDisbaleConfirmPage;
	}
	...
	public String updatePassword(@RequestParam("user") final String user, final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute("breadcrumbs", breadcrumbs);
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUserResetPasswordPage;
	}
			...
			throws CMSItemNotFoundException
	{
		...
		model.addAttribute("cancelUrl", getCancelUrl(MANAGE_USER_DETAILS_URL, request.getContextPath(), user));
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUserCustomersPage;
	}
			...
			throws CMSItemNotFoundException
	{
		...
		model.addAttribute("cancelUrl", getCancelUrl(MANAGE_USER_DETAILS_URL, request.getContextPath(), user));
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUserPermissionsPage;
	}
			...
			throws CMSItemNotFoundException
	{
		...
		model.addAttribute("cancelUrl", getCancelUrl(MANAGE_USER_DETAILS_URL, request.getContextPath(), user));
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyRemoveDisableConfirmationPage;
	}
			...
			throws CMSItemNotFoundException
	{
		...
		model.addAttribute("cancelUrl", getCancelUrl(MANAGE_USER_DETAILS_URL, request.getContextPath(), user));
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUserB2BUserGroupsPage;
	}
	...
	@RequireHardLogIn
	public String editUsersPermission(@RequestParam("user") final String user, @RequestParam("permission") final String permission,
			final Model model, final HttpServletRequest request) throws CMSItemNotFoundException
	{
		model.addAttribute("cancelUrl", getCancelUrl(MANAGE_USER_DETAILS_URL, request.getContextPath(), user));
		model.addAttribute("saveUrl",
	...
	@RequireHardLogIn
	public String editUsersPermission(@RequestParam("user") final String user, @RequestParam("permission") final String permission,
			@Valid final B2BPermissionForm b2BPermissionForm, final BindingResult bindingResult, final Model model,
