...
public class DefaultTravelCommerceStockServiceTest
{
	...
	{
		final Collection<WarehouseModel> transportOfferings = new ArrayList<>();
		...
		when(commerceStockLevelCalculationStrategy.calculateAvailability(Matchers.anyCollectionOf(StockLevelModel.class)))
				.thenReturn(10L);
		travelCommerceStockService.getStockLevelQuantity(productModel, transportOfferings);
	...
	public void testStockLevelForEmptyTransportOfferings()
	{
		...
		travelCommerceStockService.getStockLevelQuantity(productModel, Collections.EMPTY_LIST);
