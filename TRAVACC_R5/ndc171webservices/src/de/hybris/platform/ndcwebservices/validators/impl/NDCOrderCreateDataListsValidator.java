...
/**
 * The Concrete class that validates {@link DataListType} element for {@link OrderCreateRQ}
 */
public class NDCOrderCreateDataListsValidator implements NDCRequestValidator<OrderCreateRQ>
{
	...
	{
		if (Objects.isNull(orderCreateRQ.getQuery().getDataLists()))
		{
			addError(errorsType,
		...
		if (Objects.isNull(orderCreateRQ.getQuery().getDataLists().getPassengerList()))
		{
			addError(errorsType,
