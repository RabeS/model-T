...
import de.hybris.platform.ndcfacades.ndc.BaggageListRS.DataLists.PassengerList;
import de.hybris.platform.ndcfacades.ndc.BaggageListRS.Services;
import de.hybris.platform.ndcfacades.ndc.BaggageListRS.Services.Service;
...
/**
 * The NDC offer populator for {@link BaggageListRS}
 */
public class NDCBaggageListRSPopulator extends NDCAbstractOfferRSPopulator implements Populator<OfferResponseData, BaggageListRS>
{
	...
	/**
	 * This method populates price data for every offer/ancillaries in {@link BaggageListRS}.
	 *
	 * @param passengerList
	 *           the passenger list
	 * @param prices
