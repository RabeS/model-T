...
<div class="y_reservationTotalsComponent reservationTotals">
    ...
    <div class="visible-xs-block sidebar-mobile-content-section clearfix">
        <div class="text-center">
            <button type="button" data-toggle="collapse" data-target=".reservation.summary" class="glyphicon glyphicon-align-justify y_fareSlide"></button>
        </div>
    </div>
    <div>
    ...
    <div class="form-group clearfix hidden-xs">
        <div class="col-xs-offset-2 col-xs-8">
            <div class="row">
                <button class="y_seeFullReservationBtn btn btn-primary col-xs-12" data-target="y_fullReservationModal" data-toggle="modal" ${empty reservationCode ? 'disabled' : ''}><spring:theme code="reservation.full.link.title" text="See full reservation"/></button>
            </div>
        </div>
    </div>
</div>
