...
public class RuleSalesAppAccommodationReservationConditionTranslator extends AbstractSalesApplicationConditionTranslator
{
	@Override
			...
			final RuleConditionDefinitionData ruleConditionDefinitionData)
	{
		...
		return super.translate(context, condition, ruleConditionDefinitionData, accommodationReservationRAOVariable);
	}
}
