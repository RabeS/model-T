...
/**
 * The type Rule search date condition translator.
 */
public class RuleSearchDateConditionTranslator implements RuleConditionTranslator
{
			...
			final RuleConditionDefinitionData ruleConditionDefinitionData)
	{
		...
		irDateCondition.setVariable(searchParamsRAOVariable);
