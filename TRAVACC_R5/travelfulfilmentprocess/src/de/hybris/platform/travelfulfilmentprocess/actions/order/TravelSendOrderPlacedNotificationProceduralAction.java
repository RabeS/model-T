 ...
 */
public class TravelSendOrderPlacedNotificationProceduralAction extends AbstractProceduralAction<OrderProcessModel>
{

	private static final Logger LOG = Logger.getLogger(TravelSendOrderPlacedNotificationProceduralAction.class);
