...
public class AssignStockInventoryForProductConfigurationRenderer extends AbstractStockInventoryConfigurationRenderer
{
			...
			final StockLevelAttributes stockLevelAttributes, final boolean isPlusButtonNeedToAdd)
	{
		...
		ProductModel ancillaryProduct = null;
		if (Objects.nonNull(stockLevelAttributes))
		{
			...
			ancillaryProduct = stockLevelAttributes.getAncillaryProduct();
		}
		row.appendChild(
				createEditor(widgetInstanceManager, REFERENCE_TYPE + "(" + AncillaryProductModel._TYPECODE + ")", ancillaryProduct, false,
