...
/**
 * Unit test class for {@link DealRoomRatesHandler}
 */

@UnitTest
@RunWith(MockitoJUnitRunner.class)
public class DealRoomRatesHandlerTest
{
	@InjectMocks
	private DealRoomRatesHandler handler;
	...
	public void testPopulate() throws ParseException
	{
		...
		bundleTemplateModel.setProducts(Collections.singletonList(productModel));
