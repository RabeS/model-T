...
<%@ taglib prefix="travelacceleratorstorefrontbookingDetails" tagdir="/WEB-INF/tags/addons/travelacceleratorstorefront/responsive/bookingdetails"%>
...
<c:choose>
	<c:when test="${empty pageNotAvailable}">
			...
			<div class="panel button-wrap">
				<div class="col-xs-12 col-sm-6 col-lg-8">
					<dl class="booking status">
						...
						<dd>
							<travelacceleratorstorefrontbookingDetails:status code="${globalReservationData.bookingStatusCode}" name="${globalReservationData.bookingStatusName}" />
						</dd>
					</dl>
				</div>
		...
		<c:if test="${globalReservationData.accommodationReservationData != null}">
			<travelacceleratorstorefrontbookingDetails:accommodationBookingDetails accommodationReservationData="${globalReservationData.accommodationReservationData}" isTravelSite="true" customerReviews="${customerReviews}" />
		</c:if>
