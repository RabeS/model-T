...
/**
 * The type Rule accommodation offering cart condition translator.
 */
public class RuleAccommodationOfferingCartConditionTranslator implements RuleConditionTranslator
{
			...
			final RuleConditionDefinitionData ruleConditionDefinitionData)
	{
		...
		createGroupAccommodationOfferingOrCondition(accommodationOfferings, ACCOMMODATION_OFFERING_ATTRIBUTE,
				accommodationOfferingRAOVariable,
				irAccommodationOfferingCondition, RuleIrAttributeOperator.CONTAINS);
