...
public class PerPaxPopulatePropertyMapStrategyTest
{
	@InjectMocks
	PerPaxPopulatePropertyMapStrategy perPaxPopulatePropertyMapStrategy;

	@Test
	public void testPopulatePropertiesMap()
	{
		final Map<String, Object> results = perPaxPopulatePropertyMapStrategy.populatePropertiesMap(null, 0, null, null,
