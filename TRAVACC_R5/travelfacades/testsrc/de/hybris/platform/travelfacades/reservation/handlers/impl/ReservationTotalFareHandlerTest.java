...
public class ReservationTotalFareHandlerTest
{
	...
	public void setUp()
	{
		...
		given(travelCommercePriceFacade.createPriceData(70d, "GBP")).willReturn(testDataSetUp.createPriceData(80d));
		given(travelCommercePriceFacade.createPriceData(100d, "GBP")).willReturn(testDataSetUp.createPriceData(80d));
	...
	public void testPurchaseFlow()
	{
		...
		final AbstractOrderEntryModel entry1 = testDataSetUp
				.createCartEntryModel(fareProduct1, 1, 1, 20d, 20d, travellerAdult1, 1L);
		...
		final AbstractOrderEntryModel entry2 = testDataSetUp
				.createCartEntryModel(fareProduct2, 1, 1, 20d, 20d, travellerChild1, 1L);

		final ProductModel feeProduct = testDataSetUp.createFeeProduct();
		final AbstractOrderEntryModel entry3 = testDataSetUp.createCartEntryModel(feeProduct, 1, 1, 10d, 10d, null, 1L);

		final ProductModel ancillaryProduct = testDataSetUp.createAncillaryProduct();
		final AbstractOrderEntryModel entry4 = testDataSetUp.createCartEntryModel(ancillaryProduct, 1, 0, 10d, 10d, null, 1L);
		final AbstractOrderEntryModel entry5 = testDataSetUp.createCartEntryModel(ancillaryProduct, 1, 1, 10d, 10d, null, 1L);
		final AbstractOrderEntryModel entry6 = testDataSetUp.createCartEntryModel(ancillaryProduct, 1, 0, 10d, 10d, null, 0L);
		...
		assertEquals(BigDecimal.valueOf(80.0d), reservationData.getTotalFare().getTotalPrice().getValue());

		abstractorderModel.setOriginalOrder(null);
		handler.handle(abstractorderModel, reservationData);
		assertEquals(BigDecimal.valueOf(80d), reservationData.getTotalFare().getBasePrice().getValue());
		assertEquals(BigDecimal.valueOf(80.0d), reservationData.getTotalToPay().getValue());
		assertEquals(BigDecimal.valueOf(80.0d), reservationData.getTotalFare().getTotalPrice().getValue());
	}
