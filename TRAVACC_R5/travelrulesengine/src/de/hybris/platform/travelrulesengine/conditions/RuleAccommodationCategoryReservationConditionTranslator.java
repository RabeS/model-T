...
/**
 * The type Rule accommodation category reservation condition translator.
 */
public class RuleAccommodationCategoryReservationConditionTranslator implements RuleConditionTranslator
{
			...
			final RuleConditionDefinitionData ruleConditionDefinitionData)
	{
		...
		addCategoryGroupCondition(categories, ACCOMMODATION_CATEGORIES_ATTRIBUTE, accommodationRAOVariable,
	 ...
	 */
	protected void addCategoryGroupCondition(final List<String> categories, final String attribute, final String raoVariable,
