...
public class DefaultTransportOfferingFacadeIntegrationTest extends ServicelayerTransactionalTest
{
	...
	private static final String LONDON_LOCATION_CODE = "LON";
	private static final String PARIS_LOCATION_CODE = "PAR";
	private static final String NEWYORK_LOCATION_CODE = "NYC";
	...
	private void createSingleSectorRoute(final String travelRouteCode)
	{
		...
		travelRoute.setOrigin(getTransportFacilityModel(LONDON_HEATHROW, LONDON_HEATHROW_NAME, LONDON_LOCATION_CODE));
		travelRoute.setDestination(getTransportFacilityModel(CHARLE_DE_GAULLE, CHARLE_DE_GAULLE_NAME, PARIS_LOCATION_CODE));
		...
		sector.setOrigin(getTransportFacilityModel(LONDON_HEATHROW, LONDON_HEATHROW_NAME, LONDON_LOCATION_CODE));
		sector.setDestination(getTransportFacilityModel(CHARLE_DE_GAULLE, CHARLE_DE_GAULLE_NAME, PARIS_LOCATION_CODE));
	...
	private void createMultiSectorRoute(final String travelRouteCode)
	{
		...
		travelRoute.setOrigin(getTransportFacilityModel(JOHN_F_KENNEDY, JOHN_F_KENNEDY_NAME, NEWYORK_LOCATION_CODE));
		travelRoute.setDestination(getTransportFacilityModel(CHARLE_DE_GAULLE, CHARLE_DE_GAULLE_NAME, PARIS_LOCATION_CODE));
		...
		sector1.setOrigin(getTransportFacilityModel(JOHN_F_KENNEDY, JOHN_F_KENNEDY_NAME, NEWYORK_LOCATION_CODE));
		sector1.setDestination(getTransportFacilityModel(LONDON_HEATHROW, LONDON_HEATHROW_NAME, LONDON_LOCATION_CODE));

		final TravelSectorModel sector2 = new TravelSectorModel();
		sector2.setCode("S003");
		sector2.setName("London to Paris", Locale.ENGLISH);
		sector2.setOrigin(getTransportFacilityModel(LONDON_HEATHROW, LONDON_HEATHROW_NAME, LONDON_LOCATION_CODE));
		sector2.setDestination(getTransportFacilityModel(CHARLE_DE_GAULLE, CHARLE_DE_GAULLE_NAME, PARIS_LOCATION_CODE));
	...
	private void createTripleSectorRouteWithInvalidSecondSector(final String travelRouteCode)
	{
		...
		travelRoute.setOrigin(getTransportFacilityModel(LONDON_HEATHROW, LONDON_HEATHROW_NAME, LONDON_LOCATION_CODE));
		travelRoute.setDestination(getTransportFacilityModel(JOHN_F_KENNEDY, JOHN_F_KENNEDY_NAME, NEWYORK_LOCATION_CODE));
		...
		sector1.setOrigin(getTransportFacilityModel(LONDON_HEATHROW, LONDON_HEATHROW_NAME, LONDON_LOCATION_CODE));
		sector1.setDestination(getTransportFacilityModel(CHARLE_DE_GAULLE, CHARLE_DE_GAULLE_NAME, PARIS_LOCATION_CODE));
		...
		sector2.setOrigin(getTransportFacilityModel(CHARLE_DE_GAULLE, CHARLE_DE_GAULLE_NAME, PARIS_LOCATION_CODE));
		sector2.setDestination(getTransportFacilityModel(LONDON_HEATHROW, LONDON_HEATHROW_NAME, LONDON_LOCATION_CODE));
		...
		sector3.setOrigin(getTransportFacilityModel(LONDON_HEATHROW, LONDON_HEATHROW_NAME, LONDON_LOCATION_CODE));
		sector3.setDestination(getTransportFacilityModel(JOHN_F_KENNEDY, JOHN_F_KENNEDY_NAME, NEWYORK_LOCATION_CODE));
	...
	private void createRouteSectorWithNoSolrTransportOfferingsForFirstSector(final String travelRouteCode)
	{
		...
		travelRoute.setOrigin(getTransportFacilityModel(JOHN_F_KENNEDY, JOHN_F_KENNEDY_NAME, NEWYORK_LOCATION_CODE));
		travelRoute.setDestination(getTransportFacilityModel(LONDON_HEATHROW, LONDON_HEATHROW_NAME, LONDON_LOCATION_CODE));
	 ...
	 * @return
	 */
	private TransportFacilityModel getTransportFacilityModel(final String code, final String name, final String locationCode)
	{
		...
		if (transportFacility == null)
		{
			...
			transportFacility.setLocation(createLocationModel(locationCode));
	...
	/**
	 * Creates and returns a LocationModel with the specified location code
	 *
	 * @param locationCode
	 ...
	 */
	private LocationModel createLocationModel(final String locationCode)
	{
		final LocationModel locationModel = new LocationModel();
		locationModel.setCode(locationCode);
		locationModel.setLocationType(LocationType.CITY);
