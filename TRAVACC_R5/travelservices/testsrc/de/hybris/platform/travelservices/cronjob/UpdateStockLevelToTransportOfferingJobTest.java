...
public class UpdateStockLevelToTransportOfferingJobTest
{
	...
	public void prepare()
	{
		...
		final SearchResult<TransportOfferingModel> searchResult = new SearchResult<TransportOfferingModel>() {
			@Override
			public int getCount() {
				return 0;
			}
			...
			@Override
			public List<TransportOfferingModel> getResult() {
		...
		given(transportOfferingService.getTransportOfferings(anyInt(),anyInt())).willReturn(searchResult);
		...
		given(updateStockLevelsToTransportOfferingCronJobModel.getBatchSize()).willReturn(100);
	}
	...
	public void testPerformUpdateStockLevelsToTransportOfferingCronJobModel()
	{
		...
		verify(transportOfferingService).getTransportOfferings(100,0);
	...
	public void testPerformUpdateStockLevelsToTransportOfferingCronJobModelWithDomesticAirport()
	{
		...
		updateStockLevelToTransportOfferingJob.perform(updateStockLevelsToTransportOfferingCronJobModel);
		verify(transportOfferingService).getTransportOfferings(100,0);
		verify(mock_LHREDI, times(36)).getStockLevels();
	}
}
