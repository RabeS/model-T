...
public class AccommodationOfferingBasicPopulatorTest
{
	...
	@Mock
	private AbstractPopulatingConverter<LocationModel, LocationData> locationConverter;
	...
	public void setUp()
	{
		...
		given(locationConverter.convert(Matchers.any(LocationModel.class))).willReturn(null);
