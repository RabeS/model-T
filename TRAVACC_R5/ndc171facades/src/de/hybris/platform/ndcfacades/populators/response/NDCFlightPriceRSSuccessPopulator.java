...
/**
 * NDC Success Populator for {@link FlightPriceRS}
 */
public class NDCFlightPriceRSSuccessPopulator extends NDCRSSuccessPopulator implements Populator<FlightPriceRQ, FlightPriceRS>
{
	@Override
	public void populate(final FlightPriceRQ flightPriceRQ, final FlightPriceRS flightPriceRS) throws ConversionException
	{
		flightPriceRS.setSuccess(getNDCSuccessType());
	}
}
