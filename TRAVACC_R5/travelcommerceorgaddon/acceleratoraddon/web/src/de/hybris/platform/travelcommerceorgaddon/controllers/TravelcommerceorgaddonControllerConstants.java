 ...
 */
package de.hybris.platform.travelcommerceorgaddon.controllers;

import de.hybris.platform.travelcommerceorgaddon.constants.TravelcommerceorgaddonConstants;


/**
 * The interface Travelcommerceorgaddon controller constants.
 */
public interface TravelcommerceorgaddonControllerConstants
{
	/**
	...
	interface Views
	{
		interface Pages
		{
			...
			interface MyCompany
			{
				...
				String VIEW_PAGE_PREFIX = ADD_ON_PREFIX + "/" + TravelcommerceorgaddonConstants.EXTENSIONNAME + "/";
				...
				String MyCompanyOrdersReportPage = VIEW_PAGE_PREFIX + "pages/company/myCompanyOrdersReportPage";
			}
		}
	}
}
