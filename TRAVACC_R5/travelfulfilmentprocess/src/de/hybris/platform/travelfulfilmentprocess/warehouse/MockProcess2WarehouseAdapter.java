...
/**
 * The type Mock process 2 warehouse adapter.
 */
public class MockProcess2WarehouseAdapter implements Process2WarehouseAdapter
{
	...
	/**
	 * Sets warehouse 2 process adapter.
	 *
	 * @param warehouse2ProcessAdapter
	 * 		the warehouse 2 process adapter
	 */
	@Required
	...
	/**
	 * Gets warehouse 2 process adapter.
	 *
	 * @return the warehouse 2 process adapter
	 */
