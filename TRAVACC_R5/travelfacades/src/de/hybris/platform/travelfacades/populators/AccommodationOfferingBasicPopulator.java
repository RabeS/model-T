...
public class AccommodationOfferingBasicPopulator implements Populator<AccommodationOfferingModel, PropertyData>
{
	...
	public void populate(final AccommodationOfferingModel source, final PropertyData target) throws ConversionException
	{
		...
		target.setAccommodationOfferingTypes(getAccommodationOfferingTypes(source));
	 ...
	 * @return the list
	 */
	protected List<String> getAccommodationOfferingTypes(final AccommodationOfferingModel accommodationOfferingModel)
	{
		return accommodationOfferingModel.getTypes().stream().map(AccommodationOfferingType::getCode).collect(Collectors.toList());
	}
	 ...
	 * @param galleryCode
	 * 		the gallery code
	 * @return the media container for selected accommodation
	 */
