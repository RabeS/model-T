...
public class AccommodationPriceHandlerTest
{
	...
	public void testPopulate()
	{
		...
		given(baseStoreModel.isNet()).willReturn(true);
		...
		given(travelCommercePriceFacade.createPriceData(PriceDataType.BUY, BigDecimal.valueOf(3d), "GBP")).willReturn(actualPriceData);
