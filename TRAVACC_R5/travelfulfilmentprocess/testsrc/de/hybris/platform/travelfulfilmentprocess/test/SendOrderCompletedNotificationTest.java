...
import de.hybris.platform.travelfulfilmentprocess.actions.order.SendOrderCompletedNotificationAction;
...
/**
 * The type Send order completed notification test.
 */
public class SendOrderCompletedNotificationTest
{
	...
	/**
	 * Test method for
	 * {@link de.hybris.platform.travelfulfilmentprocess.actions.order.SendOrderCompletedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
