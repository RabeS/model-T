...
/**
 * The Concrete class that validates {@link DataListType} element for {@link AirShoppingRQ}
 */
public class NDCAirShoppingDataListsValidator implements NDCRequestValidator<AirShoppingRQ>
{
	...
	{
		if (Objects.isNull(airShoppingRQ.getDataLists()))
		{
			addError(errorsType,
		...
		if (Objects.isNull(airShoppingRQ.getDataLists().getPassengerList()))
		{
			addError(errorsType,
