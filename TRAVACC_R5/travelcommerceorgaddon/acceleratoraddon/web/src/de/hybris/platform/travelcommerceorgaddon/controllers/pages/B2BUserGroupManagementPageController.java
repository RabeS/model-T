...
import de.hybris.platform.travelcommerceorgaddon.forms.B2BUserGroupForm;
...
public class B2BUserGroupManagementPageController extends MyCompanyPageController
{
			...
			throws CMSItemNotFoundException
	{
		...
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUserGroupsPage;
	}
			...
			throws CMSItemNotFoundException
	{
		...
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUsergroupDisableConfirmationPage;
	}
			...
			throws CMSItemNotFoundException
	{
		...
		model.addAttribute("usergroup", userGroupData);
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUsergroupRemoveConfirmationPage;
	}
			...
			throws CMSItemNotFoundException
	{
		...
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUserGroupPermissionsPage;
	}
			...
			throws CMSItemNotFoundException
	{
		...
		model.addAttribute("usergroup", userGroupData);
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUsergroupViewPage;
	}
			...
			throws CMSItemNotFoundException
	{
		...
		model.addAttribute("cancelUrl", getCancelUrl(MANAGE_USERGROUP_DETAILS_URL, request.getContextPath(), usergroup));
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUserGroupMembersPage;
	}
			...
			throws CMSItemNotFoundException
	{
		...
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUsergroupEditPage;
	}
	...
	public String createUserGroup(final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute("unit", b2bUnitFacade.getParentUnit());
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		return TravelcommerceorgaddonControllerConstants.Views.Pages.MyCompany.MyCompanyManageUsergroupCreatePage;
	}
