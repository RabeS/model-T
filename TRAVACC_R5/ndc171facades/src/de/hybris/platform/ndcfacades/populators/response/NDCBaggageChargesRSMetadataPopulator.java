...
import de.hybris.platform.ndcfacades.ndc.BagChargeResMetadataType;
import de.hybris.platform.ndcfacades.ndc.BagChargeResMetadataType.Other;
import de.hybris.platform.ndcfacades.ndc.BagChargeResMetadataType.Other.OtherMetadata;
...
/**
 * NDC Metadata Populator populate currency related information for {@link BaggageChargesRS}
 */
public class NDCBaggageChargesRSMetadataPopulator implements Populator<OfferResponseData, BaggageChargesRS>
{
	...
	{
		final BagChargeResMetadataType metadata = new BagChargeResMetadataType();
		...
		baggageChargesRS.setMetadata(metadata);
	}
