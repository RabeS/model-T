...
/**
 * The type Rule search date accommodation search response condition translator.
 */
public class RuleSearchDateAccommodationSearchResponseConditionTranslator implements RuleConditionTranslator
{
			...
			final RuleConditionDefinitionData ruleConditionDefinitionData)
	{
		...
		irDateCondition.setVariable(accommodationSearchResponseRAOVariable);
