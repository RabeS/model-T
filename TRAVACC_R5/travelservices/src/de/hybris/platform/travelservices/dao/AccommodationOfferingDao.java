...
public interface AccommodationOfferingDao extends Dao
{
	...
	/**
	 * Return list of accommodation offerings configured in the system that have stock for accommodation belonging to the
	 ...
	 * @return List<AccommodationOfferingModel> search result
	 */
	SearchResult<AccommodationOfferingModel> findAccommodationOfferings(int batchSize, int offset, String catalogId);
}
