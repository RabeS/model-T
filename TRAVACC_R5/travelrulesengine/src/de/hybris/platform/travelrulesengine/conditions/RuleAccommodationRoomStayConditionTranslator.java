...
/**
 * This is a condition translator to translate accommodation condition for roomStayRAOVariable
 */
public class RuleAccommodationRoomStayConditionTranslator implements RuleConditionTranslator
{
			...
			final RuleConditionDefinitionData ruleConditionDefinitionData)
	{
		...
		irTypeCondition.getChildren().add(irAccommodationAvailabilityCondition);
		createGroupTypeOrCondition(types, ACCOMMODATION_ATTRIBUTE, roomStayRAOVariable, irTypeCondition,
