...
/**
 * The type Default accommodation offering service integration test.
 */
@IntegrationTest
public class DefaultAccommodationOfferingServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	private final String code = "DORSET_SQUARE_HOTEL";
	...
	@Test
	public void testGetAccommodationOffering()
	{
		final AccommodationOfferingModel accommodationOffering = accommodationOfferingService.getAccommodationOffering(code);
		Assert.assertNotNull(accommodationOffering);
		Assert.assertEquals(code, accommodationOffering.getCode());
	}

	@Test
	public void testGetAccommodationOfferings()
	{
		final List<AccommodationOfferingModel> accommodationOfferings = accommodationOfferingService.getAccommodationOfferings();
		Assert.assertTrue(CollectionUtils.isNotEmpty(accommodationOfferings));
	}

	@Test
	public void testGetAccommodationOfferingsWithBatch()
	{
		final SearchResult<AccommodationOfferingModel> accommodationOfferings = accommodationOfferingService
				.getAccommodationOfferings(10, 0);

		Assert.assertTrue(CollectionUtils.isNotEmpty(accommodationOfferings.getResult()));
	}
}
