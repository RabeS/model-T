 ...
 * {@link AccommodationSearchResponseData} based on the price in an descending order
 */
public class PriceDescendingSortStrategy implements AccommodationOfferingSearchResponseSortStrategy
{
	...
	public void sort(final AccommodationSearchResponseData accommodationSearchResponseData)
	{
		Collections.sort(accommodationSearchResponseData.getProperties(), (property1, property2) -> {
			...
			return propertyRate2.compareTo(propertyRate1);
		});
	}
