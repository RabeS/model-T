...
/**
 * The Concrete class that validates {@link DataListType} element for {@link OrderChangeRQ}
 */
public class NDCOrderChangeDataListsValidator implements NDCRequestValidator<OrderChangeRQ>
{
	...
	{
		if (Objects.isNull(orderChangeRQ.getDataLists()))
		{
			addError(errorsType,
		...
		if (Objects.isNull(orderChangeRQ.getDataLists().getPassengerList()))
		{
			addError(errorsType,
