...
public class FareProductRaoPopulator implements Populator<FareProductData, FareProductRAO>
{
	...
	public void populate(final FareProductData source, final FareProductRAO target) throws ConversionException
	{
		...
		target.setCategories(new HashSet<>(Converters.convertAll(source.getCategories(), getCategoryDataRaoConverter())));
	 ...
	 */
	@Required
	public void setCategoryDataRaoConverter(final Converter<CategoryData, CategoryRAO> categoryDataRaoConverter)
	{
