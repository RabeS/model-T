...
public class RatePlansHandlerTest
{
	...
	public void testPopulate()
	{
		...
		final AccommodationAvailabilityResponseData accommodationAvailabilityResponseData = new
	...
	private class TestDataSetUp
	{
		...
		public CriterionData createCriterionData(final PropertyData accommodationReference, final StayDateRangeData stayDateRange)
		{
			...
			criterion.setRoomStayCandidates(Collections.singletonList(createRoomStayCandidateData(0, "TEST_RATE_PLAN_CODE")));
			return criterion;
		}
		...
		public RoomStayCandidateData createRoomStayCandidateData(final int roomStayCandidateRefNumber, final String ratePlanCode)
		{
			...
			roomStayCandidateData.setPassengerTypeQuantityList(Collections.singletonList(createPassengerTypeQuantityData()));
			return roomStayCandidateData;
		}

		public PassengerTypeQuantityData createPassengerTypeQuantityData()
		{
			final PassengerTypeQuantityData passengerTypeQuantityData = new PassengerTypeQuantityData();
			final PassengerTypeData passengerTypeData1 = new PassengerTypeData();
			passengerTypeData1.setCode("adult");
			passengerTypeQuantityData.setPassengerType(passengerTypeData1);
