...
public class DefaultNDCOrderEntryFacade extends AbstractNDCFacade implements NDCOrderEntryFacade
{
	...
	/**
	 * Creates {@link TravellerModel} from the list of {@link PassengerType} provided
	 *
	 * @param passengers
	 *           the passengers
	 * @param orderCode
			...
			final List<TravellerModel> travellers) throws NDCOrderException
	{
		...
		{
			if (!(product instanceof AncillaryProductModel || ProductType.ANCILLARY.equals(product.getProductType())))
			{
				continue;
			}
