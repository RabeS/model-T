...
/**
 * The type Rule accommodation search date condition translator.
 */
public class RuleSearchDateAccommodationReservationConditionTranslator implements RuleConditionTranslator
{
			...
			final RuleConditionDefinitionData ruleConditionDefinitionData)
	{
		...
		irDateCondition.setVariable(accommodationReservationRAOVariable);
