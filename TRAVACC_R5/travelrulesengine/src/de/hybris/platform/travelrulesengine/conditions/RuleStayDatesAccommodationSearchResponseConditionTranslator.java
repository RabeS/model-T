...
/**
 * The type Rule stay dates accommodation search response condition translator.
 */
public class RuleStayDatesAccommodationSearchResponseConditionTranslator extends AbstractStayDatesConditionTranslator
{
	@Override
			...
			final RuleConditionDefinitionData ruleConditionDefinitionData)
	{
		...
		return super.translate(condition, accommodationSearchResponseRAOVariable);
	}
}
