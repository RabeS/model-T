...
{
	public static final String HOME_PAGE_BACKGROUND_IMAGE = "backgroundImage";
			...
			final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
		...
		storeBackgroundImageInModel(model, getContentPageForLabelOrId(null));
	...
	protected void storeBackgroundImageInModel(final Model model, final AbstractPageModel cmsPage)
	{
		if (cmsPage instanceof ContentPageModel)
		{
			model.addAttribute(HOME_PAGE_BACKGROUND_IMAGE, ((ContentPageModel) cmsPage).getBackgroundImage());
		}
	}
}
