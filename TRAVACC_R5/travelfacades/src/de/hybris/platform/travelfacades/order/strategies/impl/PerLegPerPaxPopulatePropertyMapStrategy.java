 ...
 */
public class PerLegPerPaxPopulatePropertyMapStrategy implements PopulatePropertyMapStrategy
{
			...
			final AmendStatus amendStatus)
	{
		...
		propertiesMap.put(TravelOrderEntryInfoModel.TRAVELLERS, travellersList);
