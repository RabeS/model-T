...
public class UpdateUpgradeBundlePricesHandlerTest
{
	...
	public void testHandle()
	{
		...
		priceDifference.setValue(BigDecimal.valueOf(50d));
		itineraryPricingInfo2.getTotalFare().setPriceDifference(priceDifference);
	...
	class TestDataSetup
	{
		...
		public ItineraryPricingInfoData createItineraryPricingInfoData(final double totalValue, final boolean selected)
		{
			...
			totalFare.setTotalPrice(totalPrice);
			final PriceData priceDifference = new PriceData();
			priceDifference.setValue(BigDecimal.ZERO);
			totalFare.setPriceDifference(priceDifference);
