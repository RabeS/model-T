 ...
 * roomStayRAOVariable
 */
public class RuleDayOfWeekAccommodationAvailabilitytConditionTranslator extends AbstractDaysOfWeekConditionTranslator
{
	@Override
			...
			final RuleConditionDefinitionData ruleConditionDefinitionData)
	{
		...
		final RuleIrGroupCondition irDayOfWeekGroupCondition =
				super.translate(condition, accommodationAvailabilityRequestRAOVariable);
		...
		irDayOfWeekGroupCondition.getChildren().add(irRoomStayRAOCondition);

		return irDayOfWeekGroupCondition;
	}
}
