...
/**
 * unit test for {@link AddExactlyNQuantityExtrasStrategy}
 */
@UnitTest
@RunWith(MockitoJUnitRunner.class)
public class AddExactlyNQuantityExtrasStrategyTest
{
	@InjectMocks
	AddExactlyNQuantityExtrasStrategy addExactlyNQuantityExtrasStrategy;
	...
	@Mock
	private AddExactlyNRestrictionModel accommodationRestrictionModel;
	...
	public void testApplyStrategyForRoomStayDataOfSameDate()
	{
		...
		given(accommodationRestrictionModel.getTripMaxOfferQty()).willReturn(new Integer(2));
		...
		addExactlyNQuantityExtrasStrategy.applyStrategy(productModel, reservedRoomStayData, accommodationReservationData);
	}
	...
	public void testApplyStrategyForNullAddToCriteria()
	{
		...
		final ReservedRoomStayData reservedRoomStayData = createReservedRoomStayData(1, 1);
		given(accommodationRestrictionModel.getTripMaxOfferQty()).willReturn(null);
		final AccommodationReservationData accommodationReservationData = createAccommodationReservationData();
		Assert.assertEquals(null, addExactlyNQuantityExtrasStrategy
	...
	public void testApplyStrategy()
	{
		...
		given(commerceStockService.getStockForDate(productModel, date, Arrays.asList(accommodationOfferingModel)))
				.willReturn(new Integer(1));
		final ReservedRoomStayData reservedRoomStayData = createReservedRoomStayData(1, 1);
		given(accommodationRestrictionModel.getTripMaxOfferQty()).willReturn(new Integer(0));
		final AccommodationReservationData accommodationReservationData = createAccommodationReservationData();
		Assert.assertEquals(AddToCartCriteriaType.PER_LEG.getCode(), addExactlyNQuantityExtrasStrategy
				.applyStrategy(productModel, reservedRoomStayData, accommodationReservationData).getAddToCartCriteria());
	}
