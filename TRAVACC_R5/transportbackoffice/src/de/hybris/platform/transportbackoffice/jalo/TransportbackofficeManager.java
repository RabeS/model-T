 ...
 */
package de.hybris.platform.transportbackoffice.jalo;
...
import de.hybris.platform.transportbackoffice.constants.TransportbackofficeConstants;
 ...
 */
public class TransportbackofficeManager extends GeneratedTransportbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TransportbackofficeManager.class.getName());
	 ...
	 */
	public static TransportbackofficeManager getInstance()
	{
		return (TransportbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TransportbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TransportbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TransportbackofficeManager called.");
		}
	}
