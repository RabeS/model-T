...
<div class="panel-body">
	<div class="row">
		...
		<div class="col-xs-12 col-sm-4">
			<a id="${not empty isPackage && isPackage ? 'y_packageUpgradeBundleOptionsButton' : 'y_upgradeBundleOptionsButton'}" data-toggle="collapse" data-target="#y_panel-upgrade" aria-expanded="false" aria-controls="y_panel-upgrade" class="btn btn-primary btn-block" data-amend="${fn:escapeXml(amend)}">
