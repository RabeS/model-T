 ...
 */
public class GlobalUserGroupTypeRestriction implements GlobalBookingActionEnabledEvaluatorStrategy
{
	private UserService userService;
	private List<String> restrictedUserGroupCodeList;

	private static final String ALTERNATIVE_MESSAGE = "booking.action.global.user.group.alternative.message";
