...
<%@ taglib prefix="travelBookingDetails" tagdir="/WEB-INF/tags/addons/travelacceleratorstorefront/responsive/bookingdetails"%>
				...
				<div class="panel button-wrap">
					<div class="col-xs-12 col-md-4">
						<dl class="booking status">
							...
							<dd>
								<travelBookingDetails:status code="${reservationData.bookingStatusCode}" name="${reservationData.bookingStatusName}" />
							</dd>
						</dl>
					</div>
