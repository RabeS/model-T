...
public class NDCAirShoppingRSPopulator implements Populator<FareSelectionData, AirShoppingRS>
{
	 ...
	 * @return the offers
	 */
	protected List<Offer> getOffers(final int offerIndex, final PricedItineraryData pricedItinerary, final Flight flight)
	{
		...
		for (final ItineraryPricingInfoData itineraryPricingInfo : pricedItinerary.getItineraryPricingInfos())
		{
			...
			final List<OfferItemType2> offerItems = getOfferItems(itineraryPricingInfo, pricedItinerary, flight, index);
