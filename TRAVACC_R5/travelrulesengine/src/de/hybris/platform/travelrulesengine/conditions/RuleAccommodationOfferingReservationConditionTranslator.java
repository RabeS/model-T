...
/**
 * The type Rule accommodation offering accommodation reservation condition translator.
 */
public class RuleAccommodationOfferingReservationConditionTranslator extends AbstractAccommodationOfferingConditionTranslator
{
			...
			final RuleConditionDefinitionData ruleConditionDefinitionData)
	{
		...
		return super.translate(context, condition, accommodationReservationRAOVariable);
	}
}
