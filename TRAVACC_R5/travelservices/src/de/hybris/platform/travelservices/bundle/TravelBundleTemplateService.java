...
public interface TravelBundleTemplateService extends BundleTemplateService
{
	 ...
	 */
	BundleTemplateModel getBundleTemplateByCodeAndCatalogVersion(String bundleId, String catalogId) throws ModelNotFoundException,AmbiguousIdentifierException;
}
